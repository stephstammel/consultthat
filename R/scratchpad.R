...
# documents folder: subs internal, external, meeting
# internal documents:
# project initiation folder - with note about PIN, RFP, tech specs, milestones,
# additional requirements
# financials folder - invoice information folder, invoices payable, invoices receivable
# planning folder - incld. checklist
# milestone summaries folder
# external documents:
# handover folder + checklist
...
#
# create timesheet function, startTime, finishTime functions
# add meeting minutes location + folder to the meetings folder + log
